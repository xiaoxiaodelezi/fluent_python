...
14.4	使用迭代器模拟实现Sentence类



### 生成器函数

14.5	使用生成器函数来实现Sentence类
...
14.7	在生成器函数中调用re.finditer生成器函数，实现Sentence类



### 生成器表达式

14.8	先在列表推导中使用gen_AB生成器函数，然后生成器表达式中使用

14.9	使用生成器表达式实现sentence类



### 等差数列生成器

14.10	演示ArithmeticProgression类的用法

14.11	ArithmeticProgression类

14.12	aritprog_gen生成器



### 使用itertools模块生成等差数列

14.13	与前面的aritprog_gen函数作用相同
...
14.15	演示itertools.accumulate生成器函数

14.16	演示用于映射的生成器函数

14.17	演示用于合并的生成器函数

14.18	演示itertools.product生成器函数

14.19	演示count、repeat和cycle的用法

14.20	组合学生成器函数会从输入的各个元素中产生多个值

14.21	itertools.groupby函数的用法

14.22	itertools.tee 函数产生多个生成器，每个生成器都可以产出输入的各个元素



### 可迭代的归约函数

14.23	把几个序列传给all和any函数后得到的结果
